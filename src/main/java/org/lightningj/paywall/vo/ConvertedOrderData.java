...
/**
 * Extension of OrderData also containing the amount generated
 ...
 */
public class ConvertedOrderData extends OrderData {
     ...
     * Empty Constructor
     */
    public ConvertedOrderData() {
    }

    /**
     * Default Constructor.
     *
     * @param orderData    the original payment data.
     * @param convertedAmount the amount generated by the currency converter.
     */
    public ConvertedOrderData(OrderData orderData, CryptoAmount convertedAmount) {
        super(orderData.preImageHash, orderData.description, orderData.requestedAmount, orderData.expireDate);
     ...
     */
    public ConvertedOrderData(JsonObject jsonObject) throws JsonException {
        super(jsonObject);
    }
