...
class DefaultQRCodeGeneratorSpec extends Specification {
    ...
    def "Verify that generatePNG generates a valid QRCode"(){
        ...
        when:
        byte[] data = generator.generatePNG("",200,200)
        then:
        readQRCode(data) == ""

    }


    private String readQRCode(byte[] data){
