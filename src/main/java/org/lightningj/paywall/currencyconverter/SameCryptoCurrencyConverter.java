 ...
 */
public class SameCryptoCurrencyConverter implements CurrencyConverter {
     ...
     */
    @Override
    public CryptoAmount convert(Amount amount) throws InvalidCurrencyException, IOException, InternalErrorException {
        if(amount instanceof CryptoAmount){
            return (CryptoAmount) amount;
        }
        throw new InvalidCurrencyException("Invalid currency generated by PaymentHandler, only CryptoAmount of same type as used by LightningHandler supported.");
    }
}
